...
//     const postShareButton = document.querySelector(".post-share");
...
//       postModalWrapper.classList.add("show");
//     });

//     postModalClose.addEventListener("click", function () {
//       postModalWrapper.classList.remove("show");
//     });
//   });
...
window.addEventListener("load", function () {
  ...
  setTimeout(() => {
    ...
    slickTrack.appendChild(staticSlide);
  }, 200);
});
